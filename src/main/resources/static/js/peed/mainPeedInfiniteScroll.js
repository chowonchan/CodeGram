...
class MainPeedInfiniteScroll {
      ...
      <section class="section-1">
        <div class="box-1">
          <button class="action-button like-button pointer" aria-label="좋아요">
            <svg aria-label="좋아요" class="like-icon ${board.likeCheck ? 'fa-solid' : 'fa-regular'}" height="24" width="24" viewBox="0 0 24 24">
        ...
        <div class="box-2">
          <button class="action-button mark-button pointer" aria-label="저장">
            <svg aria-label="저장" class="mark-icon ${board.markCheck ? 'fa-solid' : 'fa-regular'}" height="24" width="24" viewBox="0 0 24 24">
  ...
  createPostInfoHTML(board) {
    return `
      <div>좋아요 <span>${board.likeCount}</span>개</div>
