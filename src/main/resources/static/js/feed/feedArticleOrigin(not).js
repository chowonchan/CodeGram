        ...
        <div class="post">
          ...
          <div class="important-box">
            <section class="section-1">
              <div class="box-1">
                <button class="action-button like-button pointer" aria-label="좋아요" data-board-no="${board.boardNo}">
                  <svg aria-label="좋아요" class="boardLike like-icon ${board.likeCheck == 1 ? 'fa-solid' : 'fa-regular'}" height="24" width="24" viewBox="0 0 24 24">
              ...
              <div class="box-2">
                <button class="action-button mark-button pointer" aria-label="저장" data-member-no="${board.boardNo}">
                  <svg aria-label="저장" class="boardMark mark-icon ${board.markCheck == 1 ? 'fa-solid' : 'fa-regular'}" height="24" width="24" viewBox="0 0 24 24" >
            ...
            <div class="post-caption contentContainer">
              <p class="shortContent" >${board.content}</p>
              <span  class="fullContent hidden-content"></span>
